...
def main():
    ...
    for epoch in range(start_epoch, opt.num_epochs):
        ...
        # train for one epoch
        train(opt, train_loader, model, epoch, val_loader,opt.lamda1,opt.lamda2,opt.lamda3)
...
def train(opt, train_loader, model, epoch, val_loader,lamda1,lamda2,lamda3):
    ...
    for i, train_data in enumerate(train_loader):
        ...
        if opt.precomp_enc_type == 'basic':
            images, img_lengths, captions, lengths, classes,lengths_c,c_raw,tokens, _ = train_data
            model.train_emb(images, captions, lengths, classes,lengths_c,c_raw,tokens,lamda1,lamda2,lamda3,image_lengths=img_lengths)
        else:
